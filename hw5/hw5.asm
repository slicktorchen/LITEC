...
;--------------------------------------------------------
	...
	C$hw5.c$32$1$38 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:32: unsigned int counts = 0;
	clr	a
	mov	_counts,a
	mov	(_counts + 1),a
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw5.c$36$1$12 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:36: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw5.c$38$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:38: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw5.c$39$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:39: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw5.c$40$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:40: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw5.c$41$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:41: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw5.c$43$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:43: while (1) /* the following loop waits 3 seconds after a key is pressed on the
00105$:
	C$hw5.c$46$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:46: printf("Hit any key on the keyboard to start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$47$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:47: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw5.c$50$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:50: TMR0 = 0;
	clr	a
	mov	((_TMR0 >> 0) & 0xFF),a
	mov	((_TMR0 >> 8) & 0xFF),a
	C$hw5.c$51$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:51: TR0 = 1;
	setb	_TR0
	C$hw5.c$54$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:54: counts = 0;
	clr	a
	mov	_counts,a
	mov	(_counts + 1),a
	C$hw5.c$55$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:55: while(counts < 8100);
00101$:
	clr	c
	mov	a,_counts
	subb	a,#0xa4
	...
	jc	00101$
	C$hw5.c$56$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:56: printf("3 seconds have passed. \r\n");            //print that the time has elapsed
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$57$2$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:57: printf("Number of overflows: %d\r\n", counts);    // print number of overflows using count variable
	push	_counts
	push	(_counts + 1)
	mov	a,#___str_2
	push	acc
...
;------------------------------------------------------------
	...
	C$hw5.c$63$1$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:63: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw5.c$65$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:65: ET0 = 1;      // enable Timer0 Interrupt request using sbit variable 
	setb	_ET0
	C$hw5.c$66$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:66: IE |= 0x80;       // enable global interrupts using bit masking
	orl	_IE,#0x80
	C$hw5.c$67$1$34 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw5.c$69$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:69: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw5.c$72$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:72: CKCON |= 0x08;  // Timer0 uses SYSCLK or SYSCLK/12
	orl	_CKCON,#0x08
	C$hw5.c$73$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:73: TMOD &= ~0x0F;   // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$hw5.c$74$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:74: TMOD &= ~0x03;   // Timer0 mode setting
	anl	_TMOD,#0xfc
	C$hw5.c$75$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:75: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw5.c$76$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:76: TL0 = 0;         // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw5.c$77$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:77: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw5.c$79$1$36 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw5.c$83$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:83: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw5.c$87$1$38 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw5\hw5.c:87: ++counts;
	inc	_counts
	clr	a
