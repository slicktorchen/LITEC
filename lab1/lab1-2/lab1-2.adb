...
F:G$Check$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
F:G$Both_On$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Both_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Llab1_2.Check$num$1$79({1}SC:U),R,0,0,[r7]
...
S:Flab1_2$__str_2$0$0({19}DA19d,SC:S),D,0,0
S:Flab1_2$__str_3$0$0({21}DA21d,SC:S),D,0,0
S:Flab1_2$__str_4$0$0({27}DA27d,SC:S),D,0,0
