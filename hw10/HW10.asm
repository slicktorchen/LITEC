...
_Data::
	.ds 3
LHW10.ReadRanger$Data$1$137==.
_ReadRanger_Data_1_137:
	.ds 2
LHW10.ReadCompass$Data$1$139==.
_ReadCompass_Data_1_139:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	C$HW10.c$20$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:20: unsigned int PCA_count = 0, counts = 0;
	clr	a
	mov	_PCA_count,a
	mov	(_PCA_count + 1),a
	C$HW10.c$20$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:20: unsigned char addr, start_reg, num_bytes, new_range, range, new_heading, heading;
	mov	_counts,a
	mov	(_counts + 1),a
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$HW10.c$24$1$113 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:24: void main(void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$HW10.c$25$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:25: Sys_Init();
	lcall	_Sys_Init
	C$HW10.c$26$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:26: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$HW10.c$27$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:27: XBR0_Init();
	lcall	_XBR0_Init
	C$HW10.c$28$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:28: PCA_Init();
	lcall	_PCA_Init
	C$HW10.c$29$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:29: SMB_Init();
	lcall	_SMB_Init
	C$HW10.c$31$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:31: while(1) {
00106$:
	C$HW10.c$32$2$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:32: if (new_range) {
	mov	a,_new_range
	jz	00102$
	C$HW10.c$33$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:33: range = ReadRanger();
	lcall	_ReadRanger
	mov	r6,dpl
	mov	_range,r6
	C$HW10.c$34$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:34: Data[0] = 0x51; // write 0x51 to reg 0 of the ranger:
	mov	r5,_Data
	mov	r6,(_Data + 1)
	mov	r7,(_Data + 2)
	mov	dpl,r5
	...
	lcall	__gptrput
	C$HW10.c$35$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:35: i2c_write_data(0xE0, 0, Data, 1); // write one byte of data to reg 0 at addr
	mov	_i2c_write_data_PARM_2,#0x00
	...
	lcall	_i2c_write_data
	C$HW10.c$36$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:36: new_range = 0;
	mov	_new_range,#0x00
	C$HW10.c$37$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:37: printf("%d\n\r",range);
	mov	r6,_range
	mov	r7,#0x00
	push	ar6
	push	ar7
...
00102$:
	C$HW10.c$39$2$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:39: if (new_heading) {
	mov	a,_new_heading
	jz	00106$
	C$HW10.c$40$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:40: heading = ReadCompass();
	lcall	_ReadCompass
	mov	r6,dpl
	C$HW10.c$41$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:41: printf("%d\n\r", heading);
	mov  _heading,r6
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	mov	sp,a
	C$HW10.c$42$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:42: new_heading = 0;
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$HW10.c$48$1$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:48: void XBR0_Init(void) {
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$HW10.c$49$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:49: XBR0 = 0x19;
	mov	_XBR0,#0x19
	C$HW10.c$50$1$126 ==.
	XG$XBR0_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$HW10.c$52$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:52: void PCA_Init(void) {
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$HW10.c$53$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:53: PCA0MD = 0x81;
	mov	_PCA0MD,#0x81
	C$HW10.c$54$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:54: PCA0CPM2 = 0xC2;
	mov	_PCA0CPM2,#0xc2
	C$HW10.c$55$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:55: PCA0CN != 0x40;
	mov	a,_PCA0CN
	C$HW10.c$56$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:56: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$HW10.c$57$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:57: EA = 1;
	setb	_EA
	C$HW10.c$58$1$128 ==.
	XG$PCA_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$HW10.c$60$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:60: void SMB_Init(void) {
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$HW10.c$61$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:61: SMB0CR = 0x93;
	mov	_SMB0CR,#0x93
	C$HW10.c$62$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:62: ENSMB = 1;
	setb	_ENSMB
	C$HW10.c$63$1$130 ==.
	XG$SMB_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$HW10.c$65$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:65: void PCA_ISR (void) __interrupt 9 {
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	...
	push	psw
	C$HW10.c$66$1$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:66: if (CF) {
	jnb	_CF,00104$
	C$HW10.c$67$2$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:67: PCA0 = 0x7000;
	mov	((_PCA0 >> 0) & 0xFF),#0x00
	mov	((_PCA0 >> 8) & 0xFF),#0x70
	C$HW10.c$68$2$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:68: PCA_count++;                  // Start count
	inc	_PCA_count
	clr	a
	cjne	a,_PCA_count,00115$
	inc	(_PCA_count + 1)
00115$:
	C$HW10.c$69$2$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:69: if (PCA_count >= 4) {
	clr	c
	mov	a,_PCA_count
	subb	a,#0x04
	mov	a,(_PCA_count + 1)
	...
	jc	00102$
	C$HW10.c$70$3$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:70: new_range = 1;
	mov	_new_range,#0x01
	C$HW10.c$71$3$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:71: PCA_count = 0;
	clr	a
	mov	_PCA_count,a
	mov	(_PCA_count + 1),a
00102$:
	C$HW10.c$73$2$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:73: CF = 0;
	clr	_CF
	sjmp	00106$
00104$:
	C$HW10.c$75$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:75: PCA0CN &= 0xC0;               // All other interrupt types
	anl	_PCA0CN,#0xc0
00106$:
	pop	psw
	pop	acc
...
;------------------------------------------------------------
;Data                      Allocated with name '_ReadRanger_Data_1_137'
;range                     Allocated to registers 
;addr                      Allocated to registers 
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$HW10.c$79$1$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:79: unsigned int ReadRanger(void) {
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$HW10.c$83$1$137 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:83: i2c_read_data(addr, 0, Data, 1);
	mov	_i2c_read_data_PARM_3,#_ReadRanger_Data_1_137
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x00
	mov	_i2c_read_data_PARM_4,#0x01
	...
	lcall	_i2c_read_data
	C$HW10.c$84$1$137 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:84: i2c_read_data(addr, 1, Data, 1);
	mov	_i2c_read_data_PARM_3,#_ReadRanger_Data_1_137
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x01
	...
	lcall	_i2c_read_data
	C$HW10.c$85$1$137 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:85: range = (((unsigned int)Data[0] << 8) | Data[1]);
	mov	r7,_ReadRanger_Data_1_137
	mov	r6,#0x00
	mov	r4,(_ReadRanger_Data_1_137 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	mov	dph,a
	C$HW10.c$86$1$137 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:86: return range;
	C$HW10.c$87$1$137 ==.
	XG$ReadRanger$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;Data                      Allocated with name '_ReadCompass_Data_1_139'
;addr                      Allocated to registers 
;rev_num                   Allocated to registers 
;heading                   Allocated to registers 
;------------------------------------------------------------
	G$ReadCompass$0$0 ==.
	C$HW10.c$89$1$137 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:89: unsigned int ReadCompass(void) {
;	-----------------------------------------
;	 function ReadCompass
;	-----------------------------------------
_ReadCompass:
	C$HW10.c$94$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:94: i2c_read_data(addr, 0, Data, 1);
	mov	_i2c_read_data_PARM_3,#_ReadCompass_Data_1_139
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x00
	mov	_i2c_read_data_PARM_4,#0x01
	...
	lcall	_i2c_read_data
	C$HW10.c$96$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:96: i2c_read_data(addr, 12, Data, 2);
	mov	_i2c_read_data_PARM_3,#_ReadCompass_Data_1_139
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	...
	lcall	_i2c_read_data
	C$HW10.c$98$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:98: heading = (((unsigned int)Data[0] << 8) | Data[1]);
	mov	r7,_ReadCompass_Data_1_139
	mov	r6,#0x00
	mov	r4,(_ReadCompass_Data_1_139 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	mov	dph,a
	C$HW10.c$99$1$139 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw10\HW10.c:99: return heading;
	C$HW10.c$100$1$139 ==.
	XG$ReadCompass$0$0 ==.
	ret
	.area CSEG    (CODE)
