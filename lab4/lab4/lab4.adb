...
S:Llab4.getchar$c$1$43({1}SC:U),R,0,0,[]
S:Llab4.getchar_nw$c$1$45({1}SC:U),R,0,0,[]
...
S:G$desired_headings$0$0({6}DA3d,SI:U),E,0,0
S:G$desired_heading$0$0({2}SI:U),E,0,0
S:G$Data$0$0({3}DG,SC:U),E,0,0
S:G$keypad$0$0({1}SC:U),E,0,0
S:Llab4.ReadBattery$result$1$155({1}SC:U),R,0,0,[]
S:Llab4.ReadBattery$voltage$1$155({2}SI:U),R,0,0,[]
S:Llab4.ReadRanger$Data$1$159({2}DA2d,SC:U),E,0,0
S:Llab4.ReadRanger$range$1$159({2}SI:U),R,0,0,[]
S:Llab4.ReadRanger$addr$1$159({1}SC:U),R,0,0,[]
S:Llab4.ReadCompass$addr$1$161({1}SC:U),R,0,0,[]
S:Llab4.ReadCompass$Data$1$161({2}DA2d,SC:U),E,0,0
S:Llab4.ReadCompass$heading$1$161({2}SI:U),R,0,0,[]
S:Llab4.Update_Value$incr$1$179({1}SC:U),E,0,0
S:Llab4.Update_Value$maxval$1$179({2}SI:S),E,0,0
S:Llab4.Update_Value$minval$1$179({2}SI:S),E,0,0
S:Llab4.Update_Value$Constant$1$179({2}SI:S),R,0,0,[r6,r7]
S:Llab4.Update_Value$deflt$1$180({2}SI:S),R,0,0,[r4,r5]
S:Llab4.Update_Value$input$1$180({1}SC:U),R,0,0,[r3]
...
S:Flab4$__str_3$0$0({8}DA8d,SC:S),D,0,0
S:Flab4$__str_4$0$0({5}DA5d,SC:S),D,0,0
