...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw1.c$6$1$12 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:6: void main(void)    /* start main function */
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw1.c$13$1$28 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:13: Sys_Init();    /* Initialize UART, System clock and crossbar*/
	lcall	_Sys_Init
	C$hw1.c$14$1$28 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:14: putchar(' ');  /* do this because we tell you to */
	mov	dpl,#0x20
	lcall	_putchar
	C$hw1.c$15$1$28 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:15: while(1)       /* begin infinite loop */
00109$:
	C$hw1.c$17$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:17: printf("\r\n enter 1 to count to 18 or 2 to count to 270 \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw1.c$18$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:18: input=getchar();       /* get count value */
	lcall	_getchar
	mov	r7,dpl
	C$hw1.c$19$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:19: if (input=='1')        /* if input is 1, count to 18 */
	cjne	r7,#0x31,00105$
	C$hw1.c$22$3$30 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:22: imax=18;
	mov	r5,#0x12
	mov	r6,#0x00
	sjmp	00106$
00105$:
	C$hw1.c$24$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:24: else if (input=='2')   /* if input is 2, count to 270 */
	cjne	r7,#0x32,00102$
	C$hw1.c$27$3$31 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:27: imax=270;
	mov	r5,#0x0e
	mov	r6,#0x01
	sjmp	00106$
00102$:
	C$hw1.c$29$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:29: else imax=0;           /* for other inputs, skip counting */
	mov	r5,#0x00
	mov	r6,#0x00
00106$:
	C$hw1.c$30$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:30: printf("\n count value is %u  ",imax);
	push	ar6
	push	ar5
	push	ar5
	push	ar6
	...
	mov	sp,a
	C$hw1.c$31$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:31: printf("\n\n Decimal   hex \n\r");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	pop	ar6
	C$hw1.c$32$2$29 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:32: for(i=0;i<=imax;i++)
	mov	r4,#0x00
	mov	r7,#0x00
00112$:
	clr	c
	...
	jc	00109$
	C$hw1.c$34$3$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:34: count=i;
	mov	ar3,r4
	C$hw1.c$35$3$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw1\hw1.c:35: printf("%u   %x \n\r", count, count); 
	mov	r2,#0x00
	push	ar7
	push	ar6
	push	ar5
