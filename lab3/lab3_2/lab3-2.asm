...
_input::
	.ds 1
Llab3_2.ReadRanger$Data$1$136==.
_ReadRanger_Data_1_136:
	.ds 2
Llab3_2.ReadCompass$Data$1$138==.
_ReadCompass_Data_1_138:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	C$lab3_2.c$26$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:26: unsigned int PW = 0;
	clr	a
	mov	_PW,a
	mov	(_PW + 1),a
	C$lab3_2.c$27$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:27: unsigned int r_count = 0, h_count = 0, counts = 0;
	mov	_r_count,a
	mov	(_r_count + 1),a
	C$lab3_2.c$27$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:27: unsigned char addr, start_reg, num_bytes, new_range, range,new_heading, heading;
	mov	_h_count,a
	mov	(_h_count + 1),a
	C$lab3_2.c$27$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:27: unsigned int r_count = 0, h_count = 0, counts = 0;
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab3_2.c$37$1$113 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab3_2.c$40$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:40: Sys_Init();
	lcall	_Sys_Init
	C$lab3_2.c$41$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:41: putchar(' '); //the quotes in this line may not format correctly
	mov	dpl,#0x20
	lcall	_putchar
	C$lab3_2.c$42$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:42: XBR0_Init();
	lcall	_XBR0_Init
	C$lab3_2.c$43$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:43: PCA_Init();
	lcall	_PCA_Init
	C$lab3_2.c$44$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:44: SMB_Init();
	lcall	_SMB_Init
	C$lab3_2.c$46$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:46: printf("Embedded Control Stuff\n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$lab3_2.c$48$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:48: while(1) {
00106$:
	C$lab3_2.c$49$2$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:49: if(new_range) {
	mov	a,_new_range
	jz	00102$
	C$lab3_2.c$50$3$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:50: range = ReadRanger();
	lcall	_ReadRanger
	mov	r6,dpl
	mov	_range,r6
	C$lab3_2.c$51$3$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:51: Data[0] = 0x51; // write 0x51 to reg 0 of the ranger:
	mov	r5,_Data
	mov	r6,(_Data + 1)
	mov	r7,(_Data + 2)
	mov	dpl,r5
	...
	lcall	__gptrput
	C$lab3_2.c$52$3$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:52: i2c_write_data(0xE0, 0, Data, 1); // write one byte of data to reg 0 at addr
	mov	_i2c_write_data_PARM_2,#0x00
	...
	lcall	_i2c_write_data
	C$lab3_2.c$53$3$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:53: new_range = 0;
	mov	_new_range,#0x00
00102$:
	C$lab3_2.c$56$2$121 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:56: if (new_heading) {
	mov	a,_new_heading
	jz	00106$
	C$lab3_2.c$57$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:57: heading = ReadCompass();
	lcall	_ReadCompass
	mov	r6,dpl
	C$lab3_2.c$58$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:58: printf("Compass: %d\n\r", heading*(3599/2550));
	mov  _heading,r6
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	mov	sp,a
	C$lab3_2.c$59$3$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:59: new_heading = 0;
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$lab3_2.c$71$1$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:71: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$lab3_2.c$73$1$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:73: XBR0 = 0x27;  //configure crossbar for CEX0, CEX1, CEX2, SDA, SCL
	mov	_XBR0,#0x27
	C$lab3_2.c$75$1$124 ==.
	XG$XBR0_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$lab3_2.c$82$1$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:82: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$lab3_2.c$84$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:84: PCA0MD = 0x81;    // SYSCLK/12, enable CF interrupts
	mov	_PCA0MD,#0x81
	C$lab3_2.c$85$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:85: PCA0CPM0 = 0xC2;  // 16 bit, enable compare, enable PWM
	mov	_PCA0CPM0,#0xc2
	C$lab3_2.c$86$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:86: PCA0CN |= 0x40;   // enable PCA counter
	orl	_PCA0CN,#0x40
	C$lab3_2.c$87$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:87: EIE1 |= 0x08;     // enable PCA interrupt
	orl	_EIE1,#0x08
	C$lab3_2.c$88$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:88: EA = 1;           // enable global interrupts
	setb	_EA
	C$lab3_2.c$89$1$126 ==.
	XG$PCA_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$lab3_2.c$97$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:97: void SMB_Init(void) {
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$lab3_2.c$98$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:98: SMB0CR = 0x93;
	mov	_SMB0CR,#0x93
	C$lab3_2.c$99$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:99: ENSMB = 1;
	setb	_ENSMB
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$lab3_2.c$108$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:108: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$lab3_2.c$110$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:110: if (CF) {
	jnb	_CF,00106$
	C$lab3_2.c$111$2$131 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:111: PCA0 = 0x7000;
	mov	((_PCA0 >> 0) & 0xFF),#0x00
	mov	((_PCA0 >> 8) & 0xFF),#0x70
	C$lab3_2.c$112$2$131 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:112: r_count++;// start count
	inc	_r_count
	clr	a
	cjne	a,_r_count,00120$
	inc	(_r_count + 1)
00120$:
	C$lab3_2.c$113$2$131 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:113: if (r_count >= 10) {
	clr	c
	mov	a,_r_count
	subb	a,#0x0a
	mov	a,(_r_count + 1)
	subb	a,#0x00
	jc	00102$
	C$lab3_2.c$114$3$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:114: new_range = 1;
	mov	_new_range,#0x01
	C$lab3_2.c$115$3$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:115: r_count = 0;
	clr	a
	mov	_r_count,a
	mov	(_r_count + 1),a
00102$:
	C$lab3_2.c$117$2$131 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:117: h_count++;
	inc	_h_count
	clr	a
...
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:118: if (h_count >= 10) {
	clr	c
	mov	a,_h_count
	subb	a,#0x0a
	mov	a,(_h_count + 1)
	subb	a,#0x00
	jc	00104$
	C$lab3_2.c$119$3$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:119: new_heading = 1;
	mov	_new_heading,#0x01
	C$lab3_2.c$120$3$133 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:120: h_count = 0;
	clr	a
	mov	_h_count,a
	mov	(_h_count + 1),a
00104$:
	C$lab3_2.c$122$2$131 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:122: CF = 0;                      // clear interrupt flag
	clr	_CF
	sjmp	00108$
00106$:
	C$lab3_2.c$124$2$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:124: PCA0CN &= 0xC0;              // all other interrupt types
	anl	_PCA0CN,#0xc0
00108$:
	pop	psw
	pop	acc
	C$lab3_2.c$126$1$130 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:131: unsigned int ReadRanger(void)
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$lab3_2.c$136$1$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:136: i2c_read_data(addr, 2, Data, 2); // read two bytes, starting at reg 2
	...
	mov	dpl,#0xe0
	lcall	_i2c_read_data
	C$lab3_2.c$137$1$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:137: range = (((unsigned int)Data[0] << 8) | Data[1]);
	mov	r7,_ReadRanger_Data_1_136
	mov	r6,#0x00
	mov	r4,(_ReadRanger_Data_1_136 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	orl	a,r7
	mov	dph,a
	C$lab3_2.c$138$1$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:138: return range;
	C$lab3_2.c$139$1$136 ==.
	XG$ReadRanger$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;addr                      Allocated to registers 
;Data                      Allocated with name '_ReadCompass_Data_1_138'
;heading                   Allocated to registers 
;------------------------------------------------------------
	G$ReadCompass$0$0 ==.
	C$lab3_2.c$144$1$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:144: unsigned int ReadCompass(void)
;	-----------------------------------------
;	 function ReadCompass
;	-----------------------------------------
_ReadCompass:
	C$lab3_2.c$149$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:149: i2c_read_data(addr, 2, Data, 2); 				// read two byte, starting at reg 2
	mov	_i2c_read_data_PARM_3,#_ReadCompass_Data_1_138
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x02
	mov	_i2c_read_data_PARM_4,#0x02
	mov	dpl,#0xc0
	lcall	_i2c_read_data
	C$lab3_2.c$150$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:150: heading =(((unsigned int)Data[0] << 8) | Data[1]);	// combine the two values
	mov	r7,_ReadCompass_Data_1_138
	mov	r6,#0x00
	mov	r4,(_ReadCompass_Data_1_138 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	orl	a,r7
	mov	dph,a
	C$lab3_2.c$152$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab3\lab3_2\lab3-2.c:152: return heading;										// the heading returned in degrees between 0 and 3599
	C$lab3_2.c$153$1$138 ==.
	XG$ReadCompass$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
