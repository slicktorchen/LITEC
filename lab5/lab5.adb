...
F:G$SteeringGain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$DriveGain$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab5.getchar$c$1$43({1}SC:U),R,0,0,[]
S:Llab5.getchar_nw$c$1$45({1}SC:U),R,0,0,[]
...
S:G$PW_SS$0$0({2}SI:U),E,0,0
S:G$PW_DM$0$0({2}SI:U),E,0,0
...
S:G$kdx$0$0({2}SI:S),E,0,0
S:G$kdy$0$0({2}SI:S),E,0,0
S:G$ki$0$0({2}SI:S),E,0,0
...
S:G$keypad$0$0({1}SC:U),E,0,0
S:Llab5.ReadBattery$result$1$153({1}SC:U),R,0,0,[]
S:Llab5.ReadBattery$voltage$1$153({2}SI:U),R,0,0,[]
S:Llab5.ReadAccel$avg_gx$1$157({2}SI:S),R,0,0,[r6,r7]
S:Llab5.ReadAccel$avg_gy$1$157({2}SI:S),E,0,0
S:Llab5.ReadAccel$a_count$1$157({1}SC:U),R,0,0,[]
S:Llab5.ReadAccel$addr$1$157({1}SC:U),R,0,0,[r3]
S:Llab5.ReadAccel$status_reg$1$157({1}SC:U),E,0,0
S:Llab5.ReadAccel$Data$1$157({4}DA4d,SC:U),E,0,0
S:Llab5.calibration$addr$1$161({1}SC:U),R,0,0,[r7]
S:Llab5.calibration$status_reg$1$161({1}SC:U),R,0,0,[r6]
S:Llab5.calibration$Data$1$161({4}DA4d,SC:U),E,0,0
S:Llab5.DriveGain$temp$1$169({1}SC:U),R,0,0,[r7]
...
S:G$ReadValues$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:Flab5$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Flab5$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Flab5$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:Flab5$__str_3$0$0({8}DA8d,SC:S),D,0,0
S:Flab5$__str_4$0$0({19}DA19d,SC:S),D,0,0
S:Flab5$__str_5$0$0({47}DA47d,SC:S),D,0,0
S:Flab5$__str_6$0$0({47}DA47d,SC:S),D,0,0
S:Flab5$__str_7$0$0({38}DA38d,SC:S),D,0,0
S:Flab5$__str_8$0$0({27}DA27d,SC:S),D,0,0
S:Flab5$__str_9$0$0({10}DA10d,SC:S),D,0,0
