...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw6.c$40$1$12 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:40: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw6.c$42$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:42: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw6.c$43$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:43: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw6.c$44$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:44: Port_Init();
	lcall	_Port_Init
	C$hw6.c$45$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:45: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw6.c$46$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:46: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw6.c$48$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:48: while (1) /* the following loop contains the button pressing/tracking code */
00119$:
	C$hw6.c$50$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:50: printf("Enter a keyboard character to begin \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw6.c$51$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:51: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw6.c$52$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:52: printf("Push the button as many times as you like in 15seconds \r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw6.c$53$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:53: TR0 = 1;                                      //Initiate timer
	setb	_TR0
	C$hw6.c$54$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:54: presses = 0;								  //Initiate the values 
	clr	a
	mov	_presses,a
	mov	(_presses + 1),a
	C$hw6.c$55$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:55: presses_1 = 0;
	mov	_presses_1,a
	mov	(_presses_1 + 1),a
	C$hw6.c$56$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:56: counts = 0;
	mov	_counts,a
	mov	(_counts + 1),a
	C$hw6.c$57$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:57: while(counts < 3375) {												//Loop for 15 seconds
00115$:
	clr	c
	mov	a,_counts
	subb	a,#0x2f
...
00153$:
	C$hw6.c$58$3$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:58: if (!PB1) {														//If the pushbutton is pressed
	jb	_PB1,00115$
	C$hw6.c$59$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:59: start = counts;												//start stores the value of counts when pushbutton is pressed
	mov	_start,_counts
	mov	(_start + 1),(_counts + 1)
	C$hw6.c$60$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:60: while(counts - start < 4);									//while loop accounts for bounce
00101$:
	mov	a,_counts
	clr	c
	subb	a,_start
	...
	jc	00101$
	C$hw6.c$61$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:61: while (!PB1);												//waits for the pushbutton to be released
00104$:
	jnb	_PB1,00104$
	C$hw6.c$62$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:62: end = counts;												//end stores the value of counts after the pushbutton is released
	mov	_end,_counts
	mov	(_end + 1),(_counts + 1)
	C$hw6.c$63$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:63: if (end - start > 225) {									//If the time difference between the start and end is more than one second increment both counters
	mov	a,_end
	clr	c
	subb	a,_start
	mov	r6,a
	...
	jnc	00111$
	C$hw6.c$64$5$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:64: presses_1++;
	inc	_presses_1
	clr	a
	cjne	a,_presses_1,00158$
	inc	(_presses_1 + 1)
00158$:
	C$hw6.c$65$5$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:65: presses++;
	inc	_presses
	clr	a
	cjne	a,_presses,00115$
	inc	(_presses + 1)
	sjmp	00115$
00111$:
	C$hw6.c$66$4$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:66: } else if (end - start > 0 && end - start < 225){			//If the time difference between the start and the end is less than one second and greater than 0 seconds
	mov	a,_end
	clr	c
	subb	a,_start
	mov	r6,a
...
00161$:
	C$hw6.c$67$5$37 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:67: presses++;												//then increment only the number of presses
	inc	_presses
	clr	a
	cjne	a,_presses,00162$
	inc	(_presses + 1)
00162$:
	ljmp	00115$
00117$:
	C$hw6.c$71$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:71: printf("Number of presses: %d\r\n", presses);
	push	_presses
	push	(_presses + 1)
	mov	a,#___str_2
	push	acc
	...
	mov	sp,a
	C$hw6.c$72$2$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:72: printf("Number of presses longer than 1 sec: %d\r\n", presses_1);
	push	_presses_1
	push	(_presses_1 + 1)
	mov	a,#___str_3
	push	acc
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$hw6.c$78$1$32 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:78: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$hw6.c$80$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:80: P2MDOUT &= ~0x40;
	anl	_P2MDOUT,#0xbf
	C$hw6.c$81$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:81: P2 |= 0x40;
	orl	_P2,#0x40
	C$hw6.c$82$1$39 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$hw6.c$86$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:86: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw6.c$88$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:88: IE |= 0x02;      // enable Timer0 Interrupt request
	orl	_IE,#0x02
	C$hw6.c$89$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:89: EA = 1;       // enable global interrupts
	setb	_EA
	C$hw6.c$90$1$41 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw6.c$93$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:93: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw6.c$95$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:95: CKCON &= ~0x08;  // Timer0 uses SYSCLK/12 as source
	anl	_CKCON,#0xf7
	C$hw6.c$96$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:96: TMOD &= ~0x0F;   // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$hw6.c$97$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:97: TMOD &= ~0x03;   // Timer0 in mode 0
	anl	_TMOD,#0xfc
	C$hw6.c$98$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:98: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw6.c$99$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:99: TL0 = 0;         // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw6.c$100$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:100: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw6.c$102$1$43 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw6.c$106$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:106: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw6.c$110$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw6\hw6.c:110: counts++;
	inc	_counts
	clr	a
...
Fhw6$__str_1$0$0 == .
___str_1:
	.ascii "Push the button as many times as you like in 15seconds "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw6$__str_2$0$0 == .
...
Fhw6$__str_3$0$0 == .
___str_3:
	.ascii "Number of presses longer than 1 sec: %d"
	.db 0x0d
	.db 0x0a
	.db 0x00
	.area XINIT   (CODE)
