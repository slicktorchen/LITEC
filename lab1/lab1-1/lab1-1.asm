...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab1_1.c$37$1$12 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab1_1.c$39$1$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:39: Sys_Init();        // System Initialization
	lcall	_Sys_Init
	C$lab1_1.c$40$1$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:40: putchar(' ');      // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$lab1_1.c$41$1$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:41: Port_Init();       // Initialize ports 2 and 3 
	lcall	_Port_Init
	C$lab1_1.c$43$1$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:43: while (1)          // infinite loop 
00102$:
	C$lab1_1.c$47$2$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:47: Set_outputs();
	lcall	_Set_outputs
	sjmp	00102$
	C$lab1_1.c$49$1$33 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab1_1.c$55$1$33 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:55: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab1_1.c$58$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:58: P3MDOUT &= 0xFC; // set Port 3 output pins to push-pull mode (fill in the blank)
	anl	_P3MDOUT,#0xfc
	C$lab1_1.c$59$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:59: P3MDOUT |= 0xD8; // set Port 3 input pins to open drain mode (fill in the blank)
	orl	_P3MDOUT,#0xd8
	C$lab1_1.c$60$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:60: P3 |= 0x03; // set Port 3 input pins to high impedance state (fill in the blank)
	orl	_P3,#0x03
	C$lab1_1.c$63$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:63: P2MDOUT &= 0XFE;
	anl	_P2MDOUT,#0xfe
	C$lab1_1.c$64$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:64: P2 |= 0x01;
	orl	_P2,#0x01
	C$lab1_1.c$67$1$36 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Set_outputs$0$0 ==.
	C$lab1_1.c$74$1$36 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:74: void Set_outputs(void)
;	-----------------------------------------
;	 function Set_outputs
;	-----------------------------------------
_Set_outputs:
	C$lab1_1.c$77$1$38 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:77: if (sensor_ss() == 0)  // if Slide Switch not activated 
	lcall	_sensor_ss
	mov	a,dpl
	mov	b,dph
	orl	a,b
	jnz	00113$
	C$lab1_1.c$79$2$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:79: BILED0 = 0;   // BILED is green
	clr	_BILED0
	C$lab1_1.c$80$2$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:80: BILED1 = 1;
	setb	_BILED1
	C$lab1_1.c$81$2$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:81: printf("\rSlide switch is off \n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
...
00113$:
	C$lab1_1.c$86$2$40 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:86: BILED0 = 1;   // BILED is red
	setb	_BILED0
	C$lab1_1.c$87$2$40 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:87: BILED1 = 0;
	clr	_BILED1
	C$lab1_1.c$88$2$40 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:88: if ((sensor1() == 1) && (sensor2() == 1)) 
	lcall	_sensor1
	mov	r6,dpl
	mov	r7,dph
	cjne	r6,#0x01,00109$
	...
	cjne	r7,#0x00,00109$
	C$lab1_1.c$90$3$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:90: LED0 = 0; // LED is on
	clr	_LED0
	C$lab1_1.c$91$3$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:91: Buzzer = 1;  // Buzzer is off
	setb	_Buzzer
	C$lab1_1.c$92$3$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:92: printf("\rSlide switch on. Pushbutton 1 activated. Pushbutton 2 activated \n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
...
00109$:
	C$lab1_1.c$94$2$40 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:94: else if ((sensor1() == 1) && (sensor2() == 0)) 
	lcall	_sensor1
	mov	r6,dpl
	mov	r7,dph
	cjne	r6,#0x01,00105$
	...
	jnz	00105$
	C$lab1_1.c$96$3$42 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:96: Buzzer = 0;
	clr	_Buzzer
	C$lab1_1.c$97$3$42 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:97: LED0 = 1;
	setb	_LED0
	C$lab1_1.c$98$3$42 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:98: printf("\rSlide switch on. Pushbutton 1 activated. Pushbutton 2 not activated \n");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00105$:
	C$lab1_1.c$100$2$40 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:100: else if ((sensor1() == 0) && (sensor2() == 0))
	lcall	_sensor1
	mov	a,dpl
	mov	b,dph
	orl	a,b
	...
	jnz	00115$
	C$lab1_1.c$102$3$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:102: Buzzer = 1;
	setb	_Buzzer
	C$lab1_1.c$103$3$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:103: LED0 = 1;
	setb	_LED0
	C$lab1_1.c$104$3$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:104: printf("\rSlide switch on. \n");	
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
;------------------------------------------------------------
	G$sensor1$0$0 ==.
	C$lab1_1.c$116$1$38 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:116: int sensor1(void)
;	-----------------------------------------
;	 function sensor1
;	-----------------------------------------
_sensor1:
	C$lab1_1.c$119$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:119: if (!PB1) return 1;
	jb	_PB1,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$120$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:120: else      return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$121$1$45 ==.
	XG$sensor1$0$0 ==.
...
;------------------------------------------------------------
	G$sensor2$0$0 ==.
	C$lab1_1.c$123$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:123: int sensor2(void)
;	-----------------------------------------
;	 function sensor2
;	-----------------------------------------
_sensor2:
	C$lab1_1.c$125$1$47 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:125: if (!PB2) return 1;
	jb	_PB2,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$126$1$47 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:126: else  	  return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$127$1$47 ==.
	XG$sensor2$0$0 ==.
...
;------------------------------------------------------------
	G$sensor_ss$0$0 ==.
	C$lab1_1.c$133$1$47 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:133: int sensor_ss(void)
;	-----------------------------------------
;	 function sensor_ss
;	-----------------------------------------
_sensor_ss:
	C$lab1_1.c$136$1$49 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:136: if (!SS) return 1;
	jb	_SS,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$137$1$49 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab1\lab1-1.c:137: else     return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$138$1$49 ==.
	XG$sensor_ss$0$0 ==.
...
___str_1:
	.db 0x0d
	.ascii "Slide switch on. Pushbutton 1 activated. Pushbutton 2 activ"
	.ascii "ated "
	.db 0x0a
	.db 0x00
Flab1_1$__str_2$0$0 == .
___str_2:
	.db 0x0d
	.ascii "Slide switch on. Pushbutton 1 activated. Pushbutton 2 not a"
	.ascii "ctivated "
	.db 0x0a
	.db 0x00
Flab1_1$__str_3$0$0 == .
