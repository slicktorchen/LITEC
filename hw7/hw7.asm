...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw7.c$41$1$12 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:41: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw7.c$43$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:43: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw7.c$44$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:44: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw7.c$45$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:45: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw7.c$46$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:46: Timer_Init();    // Initialize Timer 0
	lcall	_Timer_Init
	C$hw7.c$47$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:47: Port_Init(); 
	lcall	_Port_Init
	C$hw7.c$48$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:48: ADC_Init();
	lcall	_ADC_Init
	C$hw7.c$49$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:49: printf("Start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw7.c$50$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:50: while (1) 
00102$:
	C$hw7.c$52$2$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:52: printf("enter key to read A/D input \r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw7.c$53$2$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:53: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw7.c$56$2$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:56: AD_value = read_AD_input(5);
	mov	dpl,#0x05
	lcall	_read_AD_input
	mov	_AD_value,dpl
	C$hw7.c$57$2$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:57: printf("AD value: %d \r\n", AD_value);
	mov	r6,_AD_value
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	mov	sp,a
	C$hw7.c$58$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:58: voltage = (AD_value * 2.4) / (0.5 * 256) * 1000;
	mov	dpl,_AD_value
	lcall	___uchar2fs
	mov	r4,dpl
	mov	r5,dph
	...
	mov	(_voltage + 1),dph
	C$hw7.c$59$2$35 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:59: printf("Voltage value (mV): %d \r\n", voltage);
	push	_voltage
	push	(_voltage + 1)
	mov	a,#___str_3
	push	acc
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$hw7.c$69$1$34 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:69: void ADC_Init(void)
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$hw7.c$71$1$37 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:71: REF0CN = 0x03;
	mov	_REF0CN,#0x03
	C$hw7.c$72$1$37 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:72: ADC1CF &= ~0x03;   //gain 0.5
	anl	_ADC1CF,#0xfc
	C$hw7.c$73$1$37 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:73: ADC1CN = 0x80;
	mov	_ADC1CN,#0x80
	C$hw7.c$74$1$37 ==.
	XG$ADC_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$read_AD_input$0$0 ==.
	C$hw7.c$78$1$37 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:78: unsigned char read_AD_input(unsigned char pin_number)
;	-----------------------------------------
...
_read_AD_input:
	mov	_AMX1SL,dpl
	C$hw7.c$81$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:81: ADC1CN &= ~0x20;
	anl	_ADC1CN,#0xdf
	C$hw7.c$82$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:82: ADC1CN |= 0x10;
	orl	_ADC1CN,#0x10
	C$hw7.c$83$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:83: while((ADC1CN & 0x20) == 0x00);
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$hw7.c$84$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:84: return ADC1;
	mov	dpl,_ADC1
	C$hw7.c$85$1$39 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$hw7.c$90$1$39 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:90: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$hw7.c$92$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:92: P1MDIN &= ~0x20;    //Port 1.5
	anl	_P1MDIN,#0xdf
	C$hw7.c$93$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:93: P1MDOUT &= ~0x20;   
	anl	_P1MDOUT,#0xdf
	C$hw7.c$94$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:94: P1 |= 0x20;
	orl	_P1,#0x20
	C$hw7.c$95$1$41 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$hw7.c$102$1$41 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:102: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw7.c$104$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:104: IE |= 0x82;      // enable Timer0 Interrupt request
	orl	_IE,#0x82
	C$hw7.c$105$1$43 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw7.c$107$1$43 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:107: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw7.c$110$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:110: CKCON |= 0x08;  // Timer0 uses SYSCLK 
	orl	_CKCON,#0x08
	C$hw7.c$111$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:111: TMOD &= 0xF0;   // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$hw7.c$112$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:112: TMOD |= 0x01;   // Timer0 mode 16
	orl	_TMOD,#0x01
	C$hw7.c$113$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:113: TR0 = 0;        // Stop Timer0
	clr	_TR0
	C$hw7.c$114$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:114: TL0 = 0;        // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw7.c$115$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:115: TH0 = 0;        // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw7.c$117$1$45 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw7.c$118$1$45 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:118: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw7.c$120$1$47 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:120: counts1++;
	inc	_counts1
	clr	a
...
00103$:
	C$hw7.c$121$1$47 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\hw7\hw7.c:121: counts2++;
	inc	_counts2
	clr	a
