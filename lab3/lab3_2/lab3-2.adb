...
S:Llab3_2.ReadRanger$Data$1$136({2}DA2d,SC:U),E,0,0
S:Llab3_2.ReadRanger$range$1$136({2}SI:U),R,0,0,[]
S:Llab3_2.ReadRanger$addr$1$136({1}SC:U),R,0,0,[]
S:Llab3_2.ReadCompass$addr$1$138({1}SC:U),R,0,0,[]
S:Llab3_2.ReadCompass$Data$1$138({2}DA2d,SC:U),E,0,0
S:Llab3_2.ReadCompass$heading$1$138({2}SI:U),R,0,0,[]
...
S:Flab3_2$__str_3$0$0({25}DA25d,SC:S),D,0,0
