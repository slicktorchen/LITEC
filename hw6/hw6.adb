...
S:Lhw6.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Lhw6.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$counts$0$0({2}SI:S),E,0,0
S:G$start$0$0({2}SI:S),E,0,0
S:G$end$0$0({2}SI:S),E,0,0
S:G$presses$0$0({2}SI:S),E,0,0
S:G$presses_1$0$0({2}SI:S),E,0,0
...
S:Fhw6$__str_1$0$0({58}DA58d,SC:S),D,0,0
S:Fhw6$__str_2$0$0({24}DA24d,SC:S),D,0,0
S:Fhw6$__str_3$0$0({42}DA42d,SC:S),D,0,0
