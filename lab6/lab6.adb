...
F:G$ReadBattery$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$read_ADC_input$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$ReadRanger$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$ReadCompass$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$Vertical$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LCD_input$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$Thrust_Ranger$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Thrust_Compass$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$get_heading$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$get_pgain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$get_dgain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$set_PW$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$test$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$pause$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab6.getchar$c$1$43({1}SC:U),R,0,0,[]
S:Llab6.getchar_nw$c$1$45({1}SC:U),R,0,0,[]
...
S:G$Data$0$0({3}DG,SC:U),E,0,0
S:Llab6.ReadBattery$result$1$155({1}SC:U),R,0,0,[]
S:Llab6.ReadBattery$voltage$1$155({2}SI:U),R,0,0,[]
S:Llab6.ReadRanger$Data$1$159({2}DA2d,SC:U),E,0,0
S:Llab6.ReadCompass$addr$1$161({1}SC:U),R,0,0,[]
S:Llab6.ReadCompass$Data$1$161({2}DA2d,SC:U),E,0,0
S:Llab6.ReadCompass$heading$1$161({2}SI:U),R,0,0,[]
S:Llab6.Vertical$ANGLE_PW$1$163({2}SI:U),R,0,0,[r6,r7]
S:Llab6.Vertical$input$1$163({1}SC:U),R,0,0,[r5]
S:Llab6.LCD_input$desired_headings$1$166({8}DA4d,SI:U),E,0,0
S:Llab6.LCD_input$heading_input$1$166({2}SI:U),R,0,0,[r7,r6]
S:Llab6.get_heading$desired_headings$1$185({4}DA4d,SC:U),E,0,0
S:Llab6.get_heading$heading_input$1$185({1}SC:U),R,0,0,[r7]
S:Llab6.get_pgain$pgain$1$187({2}SI:U),E,0,0
S:Llab6.get_dgain$dgain$1$189({2}SI:U),R,0,0,[]
...
S:G$LCD_input$0$0({2}DF,SV:S),C,0,0
...
S:Flab6$__str_4$0$0({36}DA36d,SC:S),D,0,0
S:Flab6$__str_5$0$0({25}DA25d,SC:S),D,0,0
S:Flab6$__str_6$0$0({44}DA44d,SC:S),D,0,0
S:Flab6$__str_7$0$0({59}DA59d,SC:S),D,0,0
S:Flab6$__str_8$0$0({68}DA68d,SC:S),D,0,0
S:Flab6$__str_9$0$0({14}DA14d,SC:S),D,0,0
S:Flab6$__str_10$0$0({41}DA41d,SC:S),D,0,0
S:Flab6$__str_11$0$0({24}DA24d,SC:S),D,0,0
S:Flab6$__str_12$0$0({39}DA39d,SC:S),D,0,0
S:Flab6$__str_13$0$0({22}DA22d,SC:S),D,0,0
S:Flab6$__str_14$0$0({9}DA9d,SC:S),D,0,0
