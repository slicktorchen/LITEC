...
F:G$Red$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Green$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Biled_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED0_On$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED0_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED1_On$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED1_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED2_On$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED2_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$BUZZER_On$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$BUZZER_Off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$all_on$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$all_off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Check$0$0({2}DF,SB0$1:U),Z,0,0,0,0,0
F:G$Lights$0$0({2}DF,DG,SI:U),Z,0,0,0,0,0
...
S:G$wait_time$0$0({2}SI:U),E,0,0
S:G$strum_time$0$0({2}SI:U),E,0,0
S:G$start_wait$0$0({2}SI:U),E,0,0
S:G$end_wait$0$0({2}SI:U),E,0,0
S:G$start_strum$0$0({2}SI:U),E,0,0
S:G$end_strum$0$0({2}SI:U),E,0,0
S:G$total_correct$0$0({2}SI:U),E,0,0
S:G$total_incorrect$0$0({2}SI:U),E,0,0
S:G$score_correct$0$0({6}DA3d,SI:U),E,0,0
S:G$score_incorrect$0$0({6}DA3d,SI:U),E,0,0
S:G$binary$0$0({6}DA3d,SI:U),E,0,0
S:G$array$0$0({3}DG,SI:U),E,0,0
S:G$random_num$0$0({1}SC:U),E,0,0
S:Llab2.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Llab2.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Llab2.Lights$x$1$143({1}SC:U),R,0,0,[r7]
S:Llab2.Lights$binary$1$144({6}DA3d,SI:U),E,0,0
S:G$correct$0$0({1}SB0$1:U),H,0,0
S:G$incorrect$0$0({1}SB0$1:U),H,0,0
S:G$strum$0$0({1}SB0$1:U),H,0,0
...
S:Flab2$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Flab2$__str_2$0$0({56}DA56d,SC:S),D,0,0
S:Flab2$__str_3$0$0({16}DA16d,SC:S),D,0,0
