...
_Data2::
	.ds 3
Lworksheet_11.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
Lworksheet_11.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
Lworksheet_11.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
Lworksheet_11.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
Lworksheet_11.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
Lworksheet_11.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
Lworksheet_11.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
Lworksheet_11.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
Lworksheet_11.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
Lworksheet_11.i2c_read_data$num_bytes$1$107==.
...
_range::
	.ds 2
Lworksheet_11.ReadCompass$Data$1$126==.
_ReadCompass_Data_1_126:
	.ds 2
Lworksheet_11.ReadRanger$Data$1$128==.
_ReadRanger_Data_1_128:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
Lworksheet_11.lcd_print$text$1$81==.
...
;--------------------------------------------------------
	...
	C$worksheet_11.c$22$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:22: unsigned int desired = 1350;          // set this value
	mov	_desired,#0x46
	mov	(_desired + 1),#0x05
	C$worksheet_11.c$23$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:23: unsigned int actual = 1350;            // set this value
	mov	_actual,#0x46
	mov	(_actual + 1),#0x05
	C$worksheet_11.c$24$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:24: unsigned int kp = 12;                // set this value
	mov	_kp,#0x0c
	mov	(_kp + 1),#0x00
	C$worksheet_11.c$25$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:25: unsigned int kd = 0;                // set this value
	clr	a
	mov	_kd,a
	mov	(_kd + 1),a
	C$worksheet_11.c$26$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:26: signed int pw_neut = 2765;             // set this value
	mov	_pw_neut,#0xcd
	mov	(_pw_neut + 1),#0x0a
	C$worksheet_11.c$27$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:27: signed int previous_error = -1760;      // set this value
	mov	_previous_error,#0x20
	mov	(_previous_error + 1),#0xf9
	C$worksheet_11.c$28$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:28: signed int error = 0;               // set this value
	mov	_error,a
	mov	(_error + 1),a
	C$worksheet_11.c$29$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:29: signed int temp_motorpw_2byte = 0;
	mov	_temp_motorpw_2byte,a
	mov	(_temp_motorpw_2byte + 1),a
	C$worksheet_11.c$30$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:30: signed long temp_motorpw_alg1 = 0;
	mov	_temp_motorpw_alg1,a
	mov	(_temp_motorpw_alg1 + 1),a
	mov	(_temp_motorpw_alg1 + 2),a
	mov	(_temp_motorpw_alg1 + 3),a
	C$worksheet_11.c$31$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:31: signed long temp_motorpw_alg2 = 0;
	mov	_temp_motorpw_alg2,a
	mov	(_temp_motorpw_alg2 + 1),a
	mov	(_temp_motorpw_alg2 + 2),a
	mov	(_temp_motorpw_alg2 + 3),a
	C$worksheet_11.c$32$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:32: signed long temp_motorpw_alg3 = 0;
	mov	_temp_motorpw_alg3,a
	mov	(_temp_motorpw_alg3 + 1),a
	mov	(_temp_motorpw_alg3 + 2),a
	mov	(_temp_motorpw_alg3 + 3),a
	C$worksheet_11.c$33$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:33: signed long temp_motorpw_alg4 = 0;
	mov	_temp_motorpw_alg4,a
	mov	(_temp_motorpw_alg4 + 1),a
	mov	(_temp_motorpw_alg4 + 2),a
	mov	(_temp_motorpw_alg4 + 3),a
	C$worksheet_11.c$34$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:34: signed long temp_motorpw_alg5 = 0;
	mov	_temp_motorpw_alg5,a
	mov	(_temp_motorpw_alg5 + 1),a
	mov	(_temp_motorpw_alg5 + 2),a
	mov	(_temp_motorpw_alg5 + 3),a
	C$worksheet_11.c$35$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:35: signed long temp_motorpw_alg6 = 0;
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$worksheet_11.c$44$1$113 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:44: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$worksheet_11.c$46$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:46: Sys_Init();
	lcall	_Sys_Init
	C$worksheet_11.c$47$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:47: SMB_Init();
	lcall	_SMB_Init
	C$worksheet_11.c$48$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:48: XBR0_Init();
	lcall	_XBR0_Init
	C$worksheet_11.c$49$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:49: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$worksheet_11.c$51$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:51: while(1) {
00104$:
	C$worksheet_11.c$52$2$119 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:52: if (i == 5) {
	mov	a,#0x05
	cjne	a,_i,00114$
	sjmp	00115$
00114$:
	ljmp	00102$
00115$:
	C$worksheet_11.c$53$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:53: i = 0;
	mov	_i,#0x00
	C$worksheet_11.c$54$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:54: actual = ReadCompass();
	lcall	_ReadCompass
	mov	_actual,dpl
	mov	(_actual + 1),dph
	C$worksheet_11.c$56$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:56: error = desired-actual;
	mov	a,_desired
	clr	c
	subb	a,_actual
	mov	_error,a
	...
	subb	a,(_actual + 1)
	mov	(_error + 1),a
	C$worksheet_11.c$57$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:57: temp_motorpw_2byte = pw_neut+kp*error+kd*(error-previous_error);
	...
	addc	a,r7
	mov	r7,a
	mov	_temp_motorpw_2byte,r6
	mov	(_temp_motorpw_2byte + 1),r7
	C$worksheet_11.c$58$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:58: temp_motorpw_alg3 = (signed long)( pw_neut + kp * (error) + kd * (error - previous_error));
	mov	_temp_motorpw_alg3,r6
	mov	(_temp_motorpw_alg3 + 1),r7
	mov	(_temp_motorpw_alg3 + 2),#0x00
	mov	(_temp_motorpw_alg3 + 3),#0x00
	C$worksheet_11.c$59$3$120 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:59: printf("Heading: %d, Error: %d, Manual: %d, Program: %ld, Range: %d\r\n", actual, error, temp_motorpw_2byte, temp_motorpw_alg3,ReadRanger());
	lcall	_ReadRanger
	mov	r6,dpl
	mov	r7,dph
	push	ar6
	...
	mov	sp,a
00102$:
	C$worksheet_11.c$61$2$119 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:61: ++i;
	inc	_i
	ljmp	00104$
	C$worksheet_11.c$86$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:86: return;
	C$worksheet_11.c$87$1$118 ==.
	XG$main$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$worksheet_11.c$89$1$118 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:89: void SMB_Init(void) {
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$worksheet_11.c$90$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:90: SMB0CR = 0x93;
	mov	_SMB0CR,#0x93
	C$worksheet_11.c$91$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:91: ENSMB = 1;
	setb	_ENSMB
	C$worksheet_11.c$92$1$122 ==.
	XG$SMB_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$worksheet_11.c$94$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:94: void XBR0_Init(void) {
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$worksheet_11.c$95$1$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:95: XBR0 = 0x25;
	mov	_XBR0,#0x25
	C$worksheet_11.c$96$1$124 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$ReadCompass$0$0 ==.
	C$worksheet_11.c$98$1$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:98: unsigned int ReadCompass(void)
;	-----------------------------------------
;	 function ReadCompass
;	-----------------------------------------
_ReadCompass:
	C$worksheet_11.c$103$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:103: i2c_read_data(addr, 2, Data, 2); 					// read two byte, starting at reg 2
	...
	mov	dpl,#0xc0
	lcall	_i2c_read_data
	C$worksheet_11.c$104$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:104: heading =(((unsigned int)Data[0] << 8) | Data[1]);	// combine the two values
	...
	orl	a,r7
	mov	dph,a
	C$worksheet_11.c$106$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:106: return heading;										// the heading returned in degrees between 0 and 3599
	C$worksheet_11.c$107$1$126 ==.
	XG$ReadCompass$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ReadRanger'
;------------------------------------------------------------
;Data                      Allocated with name '_ReadRanger_Data_1_128'
;range                     Allocated to registers 
;addr                      Allocated to registers 
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$worksheet_11.c$109$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:109: unsigned int ReadRanger(void)
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$worksheet_11.c$114$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:114: i2c_read_data(addr, 2, Data, 2);						// read two bytes, starting at reg 2
	mov	_i2c_read_data_PARM_3,#_ReadRanger_Data_1_128
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x02
	mov	_i2c_read_data_PARM_4,#0x02
	mov	dpl,#0xe0
	lcall	_i2c_read_data
	C$worksheet_11.c$115$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:115: range = (((unsigned int)Data[0] << 8) | Data[1]);
	mov	r7,_ReadRanger_Data_1_128
	mov	r6,#0x00
	mov	r4,(_ReadRanger_Data_1_128 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	orl	a,r7
	mov	dph,a
	C$worksheet_11.c$116$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab6\prelab\worksheet_11.c:116: return range;
	C$worksheet_11.c$117$1$128 ==.
	XG$ReadRanger$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
...
___str_3:
	.ascii "Heading: %d, Error: %d, Manual: %d, Program: %ld, Range: %d"
	.db 0x0d
	.db 0x0a
	.db 0x00
	.area XINIT   (CODE)
