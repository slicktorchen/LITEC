...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$kpdlcdtestPCA.c$38$1$113 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:38: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$kpdlcdtestPCA.c$41$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:41: Sys_Init();     // System Initialization - MUST BE 1st EXECUTABLE STATEMENT
	lcall	_Sys_Init
	C$kpdlcdtestPCA.c$42$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:42: Port_Init();    // Initialize ports 2 and 3 - XBR0 set to 0x05, UART0 & SMB
	lcall	_Port_Init
	C$kpdlcdtestPCA.c$43$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:43: Interrupt_Init();   // You may want to change XBR0 to match your SMB wiring
	lcall	_Interrupt_Init
	C$kpdlcdtestPCA.c$44$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:44: PCA_Init();
	lcall	_PCA_Init
	C$kpdlcdtestPCA.c$45$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:45: SMB0_Init();
	lcall	_SMB0_Init
	C$kpdlcdtestPCA.c$46$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:46: putchar('\r');  // Dummy write to serial port
	mov	dpl,#0x0d
	lcall	_putchar
	C$kpdlcdtestPCA.c$47$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:47: printf("\nStart\r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:49: Counts = 0;
	clr	a
	mov	_Counts,a
	mov	(_Counts + 1),a
	C$kpdlcdtestPCA.c$50$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:50: while (Counts < 1); // Wait a long time (1s) for keypad & LCD to initialize
00101$:
	clr	c
	mov	a,_Counts
	subb	a,#0x01
...
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:52: lcd_clear();
	lcall	_lcd_clear
	C$kpdlcdtestPCA.c$53$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:53: lcd_print("Calibration:\nHello world!\n012_345_678:\nabc def ghij");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$kpdlcdtestPCA.c$55$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:55: while (1)
00109$:
	C$kpdlcdtestPCA.c$83$2$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:83: keypad = read_keypad();
	lcall	_read_keypad
	mov	r7,dpl
	C$kpdlcdtestPCA.c$85$2$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:85: lcd_print("Hello");
	push	ar7
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	...
	dec	sp
	dec	sp
	C$kpdlcdtestPCA.c$86$2$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:86: printf("Hello\n");
	mov	a,#___str_6
	push	acc
	mov	a,#(___str_6 >> 8)
	push	acc
	...
	dec	sp
	pop	ar7
	C$kpdlcdtestPCA.c$87$2$123 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:87: if (keypad != 0xFF)   // keypad = 0xFF if no key is pressed
	cjne	r7,#0xff,00129$
	sjmp	00109$
00129$:
	C$kpdlcdtestPCA.c$91$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:91: lcd_clear();
	push	ar7
	lcall	_lcd_clear
	pop	ar7
	C$kpdlcdtestPCA.c$92$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:92: lcd_print("Your key was:\n %c,  = Hex %X", keypad, keypad);
	mov	ar5,r7
	mov	r6,#0x00
	push	ar7
	push	ar6
	...
	pop	ar5
	pop	ar6
	C$kpdlcdtestPCA.c$93$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:93: printf("\n\rYour key was: %c,  = Hex %X", keypad, keypad);
	push	ar5
	push	ar6
	push	ar5
	push	ar6
	...
	mov	sp,a
	pop	ar7
	C$kpdlcdtestPCA.c$94$3$124 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:94: if(keypad == 0)printf("   **Wire Connection/XBR0 Error**   ");
	mov	a,r7
	jz	00130$
	ljmp	00109$
00130$:
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$kpdlcdtestPCA.c$100$1$122 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:100: void Port_Init(void)	//0x05
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$kpdlcdtestPCA.c$102$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:102: XBR0 = 0x05;    // NOTE: Only UART0 & SMB enabled; SMB on P0.2 & P0.3
	mov	_XBR0,#0x05
	C$kpdlcdtestPCA.c$103$1$126 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$kpdlcdtestPCA.c$105$1$126 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:105: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$kpdlcdtestPCA.c$107$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:107: IE |= 0x02;
	orl	_IE,#0x02
	C$kpdlcdtestPCA.c$108$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:108: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$kpdlcdtestPCA.c$109$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:109: EA = 1;
	setb	_EA
	C$kpdlcdtestPCA.c$110$1$128 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$kpdlcdtestPCA.c$112$1$128 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:112: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$kpdlcdtestPCA.c$114$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:114: PCA0MD = 0x81;      // SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$kpdlcdtestPCA.c$116$1$130 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:116: PCA0CN |= 0x40;     // enable PCA
	orl	_PCA0CN,#0x40
	C$kpdlcdtestPCA.c$117$1$130 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:119: void SMB0_Init(void)    // This was at the top, moved it here to call wait()
;	-----------------------------------------
;	 function SMB0_Init
;	-----------------------------------------
_SMB0_Init:
	C$kpdlcdtestPCA.c$121$1$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:121: SMB0CR = 0x93;      // Set SCL to 100KHz
	mov	_SMB0CR,#0x93
	C$kpdlcdtestPCA.c$122$1$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:122: ENSMB = 1;          // Enable SMBUS0
	setb	_ENSMB
	C$kpdlcdtestPCA.c$123$1$132 ==.
	XG$SMB0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$kpdlcdtestPCA.c$125$1$132 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:125: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$kpdlcdtestPCA.c$127$1$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:127: if (CF)
	C$kpdlcdtestPCA.c$129$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:129: CF = 0;                     // clear the interrupt flag
	jbc	_CF,00114$
	sjmp	00104$
00114$:
	C$kpdlcdtestPCA.c$130$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:130: nOverflows++;               // continuous overflow counter
	inc	_nOverflows
	clr	a
	cjne	a,_nOverflows,00115$
	inc	(_nOverflows + 1)
00115$:
	C$kpdlcdtestPCA.c$131$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:131: nCounts++;
	inc	_nCounts
	clr	a
	cjne	a,_nCounts,00116$
	inc	(_nCounts + 1)
00116$:
	C$kpdlcdtestPCA.c$132$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:132: PCA0L = PCA_START & 0xFF;   // low byte of start count
	mov	_PCA0L,#0x00
	C$kpdlcdtestPCA.c$133$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:133: PCA0H = PCA_START >> 8;     // high byte of start count
	mov	_PCA0H,#0x70
	C$kpdlcdtestPCA.c$134$2$135 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:134: if (nCounts > 50)
	clr	c
	mov	a,#0x32
	subb	a,_nCounts
	clr	a
	subb	a,(_nCounts + 1)
	jnc	00106$
	C$kpdlcdtestPCA.c$136$3$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:136: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$137$3$136 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:137: Counts++;               // seconds counter
	inc	_Counts
;	genFromRTrack removed	clr	a
	...
	sjmp	00106$
00104$:
	C$kpdlcdtestPCA.c$140$1$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:140: else PCA0CN &= 0xC0;           // clear all other 9-type interrupts
	anl	_PCA0CN,#0xc0
00106$:
	pop	psw
	pop	acc
	C$kpdlcdtestPCA.c$141$1$134 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$pause$0$0 ==.
	C$kpdlcdtestPCA.c$143$1$134 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:143: void pause(void)
;	-----------------------------------------
;	 function pause
;	-----------------------------------------
_pause:
	C$kpdlcdtestPCA.c$145$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:145: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$146$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:146: while (nCounts < 1);// 1 count -> (65536-PCA_START) x 12/22118400 = 20ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x01
...
;------------------------------------------------------------
	G$wait$0$0 ==.
	C$kpdlcdtestPCA.c$149$1$138 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:149: void wait(void)
;	-----------------------------------------
;	 function wait
;	-----------------------------------------
_wait:
	C$kpdlcdtestPCA.c$151$1$140 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:151: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$152$1$140 ==.
;	C:\Users\Victor\Documents\RPI\LITEC\lab4\prelab\kpdlcdtestPCA.c:152: while (nCounts < 50);    // 50 counts -> 50 x 20ms = 1000ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x32
